...
`,Container$d=styled.div`
  ...
  flex-direction: column;
  padding: 0 12px;
`,renderEncoderError=()=>jsx(ErrorMessage,{children:"Your current firmware does not support rotary encoders. Install the latest firmware for your device."}),Pane$7=()=>{const[e,o]=reactExports.useState(),[n,r]=reactExports.useState(),s=useAppSelector(getSelectedKey),a=useAppDispatch(),i=useAppSelector(getSelectedKeyDefinitions),c=useAppSelector(y=>getSelectedKeymap(y)||[]),l=useAppSelector(getSelectedLayerIndex),d=useAppSelector(getSelectedConnectedDevice),u=useAppSelector(getSelectedKeyboardAPI),_=c[s??-1],p=i[s??-1],C=!!p&&p.col!==-1&&p.row!==-1,K=(y,g)=>{if(u&&s!==null&&p&&p.ei!==void 0){const m=+p.ei;switch(y){case"ccw":{u.setEncoderValue(l,m,!1,g),r(g);break}case"cw":{u.setEncoderValue(l,m,!0,g),o(g);break}case"click":{a(updateKey(s,g));break}}}},h=async(y,g,m)=>{const S=await m.getEncoderValue(y,g,!0),x=await m.getEncoderValue(y,g,!1);o(S),r(x)};return reactExports.useEffect(()=>{if(d&&d.protocol>=10&&p!==void 0&&p.ei!==void 0&&u){const y=+p.ei;h(l,y,u)}},[p,d,l]),p===void 0||d&&d.protocol<10||n===void 0||e===void 0?jsx(SpanOverflowCell,{children:renderEncoderError()}):jsx(SpanOverflowCell,{children:jsx(Encoder,{children:jsxs(Container$d,{children:[jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Counterclockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:n,meta:{},setValue:y=>K("ccw",y)})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Clockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:e,meta:{},setValue:y=>K("cw",y)})})]}),C&&jsxs(ControlRow,{children:[jsx(Label$1,{children:"Press Encoder"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:_,meta:{},setValue:y=>K("click",y)})})]})]})})})},KeycodeList=styled.div`
  display: grid;
...
`,componentJoin=(e,o)=>e.reduce((n,r,s)=>(s&&n.push({...o,key:s.toString()}),n.push(r),n),[]),KeycodeMap=getKeycodes().flatMap(e=>e.keycodes).reduce((e,o)=>({...e,[o.code]:o}),{}),optimizeKeycodeSequence=e=>pipeline(e,convertCharacterTaps,trimLastWait,mergeConsecutiveWaits,foldKeydownKeyupKeys,convertToCharacterStreams),cleanKeycodeSequence=e=>pipeline(e,mergeConsecutiveWaits),MacroRecorder=({selectedMacro:e,setUnsavedMacro:o,saveMacro:n,undoMacro:r,isDelaySupported:s})=>{const{t:a}=useTranslation(),[i,c]=reactExports.useState(!0),[l,d]=reactExports.useState(!1),[u,_]=reactExports.useState(!1),[p,C]=reactExports.useState(!!document.fullscreenElement),{smartOptimizeEnabled:K,recordDelaysEnabled:h}=useAppSelector(getMacroEditorSettings),y=useDispatch(),[g,m]=useKeycodeRecorder(l,h),S=reactExports.useRef(null),x=reactExports.useCallback(async f=>{d(f),f?(await navigator.keyboard.lock(),m([]),c(!1),_(!0)):(navigator.keyboard.unlock(),K&&m(optimizeKeycodeSequence(g)),_(!1))},[g,d]),b=reactExports.useCallback(()=>{n(""),c(!0),_(!1)},[m,n]),w=reactExports.useCallback(()=>{r(),m([]),c(!0),_(!1)},[r]);reactExports.useEffect(()=>{c(!0),_(!1),m([])},[e]);const T=()=>[...i?e??[]:g],L=reactExports.useMemo(()=>{let f,R=T();return i||!u||!K?f=R:f=optimizeKeycodeSequence(R),f},[g,i,K,u,e]);reactExports.useEffect(()=>{L&&o(sequenceToExpression(L))},[L]);const v=reactExports.useCallback(()=>{i&&c(!1)},[i]),D=reactExports.useCallback(f=>{const R=T();R.splice(f,1),m(cleanKeycodeSequence(R)),v()},[L,e,g,i]),O=reactExports.useCallback((f,R)=>{const E=T();E.splice(f,1,[RawKeycodeSequenceAction.Delay,R]),m(cleanKeycodeSequence(E)),v()},[L,e,g,i]),I=reactExports.useMemo(()=>componentJoin(L.map(([f,R],E)=>{const A=getSequenceItemComponent(f);return jsx(Deletable,{index:E,deleteItem:D,disabled:l,children:RawKeycodeSequenceAction.Delay!==f?jsx(A,{children:f===RawKeycodeSequenceAction.CharacterStream?componentJoin(String(R).split(" ").map((B,F)=>jsx("span",{children:B},F)),jsx("span",{style:{fontFamily:"fantasy, cursive, monospace"},children:"␣"})):Array.isArray(R)?R.map(B=>getSequenceLabel(KeycodeMap[B])??B).join(" + "):getSequenceLabel(KeycodeMap[R])}):jsx(WaitInput,{index:E,value:Number(R),updateValue:O})},`${E}-${f}`)}),jsx(SequenceLabelSeparator,{})),[L]);reactExports.useEffect(()=>{const f=()=>{C(!!document.fullscreenElement)};return document.documentElement.addEventListener("fullscreenchange",f),()=>{x(!1),document.documentElement.removeEventListener("fullscreenchange",f)}},[C]);const P=reactExports.useCallback(()=>{document.fullscreenElement?document.exitFullscreen&&(x(!1),document.exitFullscreen()):document.documentElement.requestFullscreen()},[x]);return jsxs(Fragment,{children:[jsx(MacroSequenceContainer,{ref:S,$isModified:!i,children:I.length?I:jsx(NoMacroRecorded,{children:a("No macro recorded yet...")})}),jsx("div",{style:{border:"none",maxWidth:960,width:"100%",display:"flex",justifyContent:"center",transform:"translate(-0px, -21px)"},children:jsx(MacroEditControls,{isFullscreen:p,isEmpty:!e||!e.length,optimizeRecording:K,recordDelays:h,isRecording:l,addText:()=>{},deleteMacro:b,toggleOptimizeRecording:()=>{y(setMacroEditorSettings({smartOptimizeEnabled:!K}))},toggleRecordDelays:()=>{y(setMacroEditorSettings({recordDelaysEnabled:!h}))},toggleFullscreen:P,undoChanges:w,saveChanges:()=>n(),hasUnsavedChanges:!i,recordingToggleChange:x,isDelaySupported:s})})]})},TextArea=styled.textarea`
  box-sizing: border-box;
  background: var(--bg_control);
  padding: 5px 10px;
...
`,TestPane=styled(Pane$9)`
  ...
  max-width: 100vw;
  flex-direction: column;
`,TestContext=React.createContext([{clearTestKeys:()=>{}},(...e)=>{}]),Test$1=()=>{const{t:e}=useTranslation(),o=useDispatch(),n=useAppSelector(getSelectedConnectedDevice),r=useAppSelector(getSelectedDefinition),s=useAppSelector(getSelectedKeyDefinitions),a=useAppSelector(getIsTestMatrixEnabled),i=useAppSelector(getTestKeyboardSoundsSettings),[c]=reactExports.useContext(TestContext),{progress:l}=useProgress(),u=n&&r&&s&&PROTOCOL_GAMMA<=n.protocol,_=a?r:fullKeyboardDefinition;if(!_||typeof _=="string")return null;const p=[{label:"Sine",value:"sine"},{label:"Triangle",value:"triangle"},{label:"Sawtooth",value:"sawtooth"},{label:"Square",value:"square"}],C=p.find(y=>y.value===i.waveform),K=[{label:"Wicki-Hayden",value:TestKeyboardSoundsMode.WickiHayden},{label:"Chromatic",value:TestKeyboardSoundsMode.Chromatic},{label:"Random",value:TestKeyboardSoundsMode.Random}],h=K.find(y=>y.value===i.mode);return l!==100?null:jsx(TestPane,{children:jsxs(Grid,{children:[jsx(MenuCell,{style:{pointerEvents:"all"},children:jsx(MenuContainer$5,{children:jsx(Row,{$selected:!0,children:jsxs(IconContainer,{children:[jsx(FontAwesomeIcon,{icon:faCircleQuestion}),jsx(MenuTooltip,{children:e("Check Key")})]})})})}),jsx(SpanOverflowCell,{children:jsxs(Container$3,{children:[jsxs(ControlRow,{children:[jsx(Label$1,{children:e("Reset Keyboard")}),jsx(Detail,{children:jsx(AccentButton,{onClick:c.clearTestKeys,children:e("Reset")})})]}),u&&r?jsxs(ControlRow,{children:[jsx(Label$1,{children:e("Test Matrix")}),jsx(Detail,{children:jsx(AccentSlider,{isChecked:a,onChange:y=>{o(setTestMatrixEnabled(y)),c.clearTestKeys()}})})]}):null,jsxs(ControlRow,{children:[jsx(Label$1,{children:e("Key Sounds")}),jsx(Detail,{children:jsx(AccentSlider,{isChecked:i.isEnabled,onChange:y=>{o(setTestKeyboardSoundsSettings({isEnabled:y}))}})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:e("Volume")}),jsx(Detail,{children:jsx(AccentRange,{max:100,min:0,defaultValue:i.volume,onChange:y=>{o(setTestKeyboardSoundsSettings({volume:y}))}})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:e("Transpose")}),jsx(Detail,{children:jsx(AccentRange,{max:24,min:-24,defaultValue:i.transpose,onChange:y=>{o(setTestKeyboardSoundsSettings({transpose:y}))}})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:e("Waveform")}),jsx(Detail,{children:jsx(AccentSelect,{isSearchable:!1,value:C,options:p,onChange:y=>{y&&o(setTestKeyboardSoundsSettings({waveform:y.value}))}})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:e("Mode")}),jsx(Detail,{children:jsx(AccentSelect,{isSearchable:!1,defaultValue:h,options:K,onChange:y=>{y&&o(setTestKeyboardSoundsSettings({mode:y.value}))}})})]})]})})]})})},Container$2=styled.div`
  display: flex;
  flex-direction: column;
  padding: 16px;
  user-select: text;
...
`,ErrorPanes=[[1,AppErrors,faComputer,"App"]],Errors=()=>{const[e,o]=reactExports.useState(0),n=(ErrorPanes.find(([r])=>e===r)||ErrorPanes[0])[1];return jsx(Pane$9,{children:jsxs(Grid,{style:{overflow:"hidden"},children:[jsx(MenuCell,{style:{pointerEvents:"all",borderTop:"none"},children:jsx(MenuContainer$5,{children:ErrorPanes.map(([r,s,a,i])=>jsx(Row,{$selected:e===r,onClick:()=>{o(r)},children:jsxs(IconContainer,{children:[jsx(FontAwesomeIcon,{icon:a}),jsx(MenuTooltip,{children:i})]})},r))})}),jsx(SpanOverflowCell,{style:{flex:1,borderWidth:0},children:jsx(n,{})})]})})},ErrorLink=()=>{const e=useAppSelector(getAppErrors),[o]=useLocation(),n=o==="/errors";return e.length?jsx(Link$1,{to:"/errors",children:jsxs(CategoryIconContainer,{$selected:n,children:[jsx(FontAwesomeIcon,{size:"xl",icon:ErrorsPaneConfig.icon,color:n?"inherit":"gold"}),jsxs(CategoryMenuTooltip,{children:[e.length," error",e.length>1?"s":""]})]})}):null},ErrorsPaneConfig={component:Errors,path:"/errors",icon:faWarning,key:"errors",title:"Errors"},PANES=[{key:"default",component:ConfigurePane,icon:faKeyboard,title:"Configure",path:"/"},{key:"test",component:Test$1,icon:faStethoscope,path:"/test",title:"Key Tester"},{key:"design",component:DesignTab,icon:faBrush,path:"/design",title:"Design"},{key:"settings",component:Settings,icon:faGear,path:"/settings",title:"Settings"},{key:"debug",icon:faBug,component:Debug,path:"/debug",title:"Debug"},ErrorsPaneConfig],ExternalLinkContainer=styled.span`
  ...
  display: flex;
  gap: 1em;
`,ExternalLinks=()=>jsx(ExternalLinkContainer,{}),Container$1=styled.div`
  position: absolute;
  right: 200px;
  font-size: 18px;
