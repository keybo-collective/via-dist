...
`,componentJoin=(e,o)=>e.reduce((n,r,s)=>(s&&n.push({...o,key:s.toString()}),n.push(r),n),[]),KeycodeMap=getKeycodes().flatMap(e=>e.keycodes).reduce((e,o)=>({...e,[o.code]:o}),{}),optimizeKeycodeSequence=e=>pipeline(e,convertCharacterTaps,trimLastWait,mergeConsecutiveWaits,foldKeydownKeyupKeys,convertToCharacterStreams),cleanKeycodeSequence=e=>pipeline(e,mergeConsecutiveWaits),MacroRecorder=({selectedMacro:e,setUnsavedMacro:o,saveMacro:n,undoMacro:r,isDelaySupported:s})=>{const{t:a}=useTranslation(),[i,c]=reactExports.useState(!0),[l,d]=reactExports.useState(!1),[u,_]=reactExports.useState(!1),[p,C]=reactExports.useState(!!document.fullscreenElement),{smartOptimizeEnabled:K,recordDelaysEnabled:h}=useAppSelector(getMacroEditorSettings),g=useDispatch(),[y,m]=useKeycodeRecorder(l,h),S=reactExports.useRef(null),f=reactExports.useCallback(async x=>{d(x),x?(await navigator.keyboard.lock(),m([]),c(!1),_(!0)):(navigator.keyboard.unlock(),K&&m(optimizeKeycodeSequence(y)),_(!1))},[y,d]),E=reactExports.useCallback(()=>{n(""),c(!0),_(!1)},[m,n]),v=reactExports.useCallback(()=>{r(),m([]),c(!0),_(!1)},[r]);reactExports.useEffect(()=>{c(!0),_(!1),m([])},[e]);const M=()=>[...i?e??[]:y],T=reactExports.useMemo(()=>{let x,w=M();return i||!u||!K?x=w:x=optimizeKeycodeSequence(w),x},[y,i,K,u,e]);reactExports.useEffect(()=>{T&&o(sequenceToExpression(T))},[T]);const R=reactExports.useCallback(()=>{i&&c(!1)},[i]),D=reactExports.useCallback(x=>{const w=M();w.splice(x,1),m(cleanKeycodeSequence(w)),R()},[T,e,y,i]),O=reactExports.useCallback((x,w)=>{const A=M();A.splice(x,1,[RawKeycodeSequenceAction.Delay,w]),m(cleanKeycodeSequence(A)),R()},[T,e,y,i]),I=reactExports.useMemo(()=>componentJoin(T.map(([x,w],A)=>{const L=getSequenceItemComponent(x);return jsx(Deletable,{index:A,deleteItem:D,disabled:l,children:RawKeycodeSequenceAction.Delay!==x?jsx(L,{children:x===RawKeycodeSequenceAction.CharacterStream?componentJoin(String(w).split(" ").map((B,F)=>jsx("span",{children:B},F)),jsx("span",{style:{fontFamily:"fantasy, cursive, monospace"},children:"␣"})):Array.isArray(w)?w.map(B=>getSequenceLabel(KeycodeMap[B])??B).join(" + "):getSequenceLabel(KeycodeMap[w])}):jsx(WaitInput,{index:A,value:Number(w),updateValue:O})},`${A}-${x}`)}),jsx(SequenceLabelSeparator,{})),[T]);reactExports.useEffect(()=>{const x=()=>{C(!!document.fullscreenElement)};return document.documentElement.addEventListener("fullscreenchange",x),()=>{f(!1),document.documentElement.removeEventListener("fullscreenchange",x)}},[C]);const P=reactExports.useCallback(()=>{document.fullscreenElement?document.exitFullscreen&&(f(!1),document.exitFullscreen()):document.documentElement.requestFullscreen()},[f]);return jsxs(Fragment,{children:[jsx(MacroSequenceContainer,{ref:S,$isModified:!i,children:I.length?I:jsx(NoMacroRecorded,{children:a("No macro recorded yet...")})}),jsx("div",{style:{border:"none",maxWidth:960,width:"100%",display:"flex",justifyContent:"center",transform:"translate(-0px, -21px)"},children:jsx(MacroEditControls,{isFullscreen:p,isEmpty:!e||!e.length,optimizeRecording:K,recordDelays:h,isRecording:l,addText:()=>{},deleteMacro:E,toggleOptimizeRecording:()=>{g(setMacroEditorSettings({smartOptimizeEnabled:!K}))},toggleRecordDelays:()=>{g(setMacroEditorSettings({recordDelaysEnabled:!h}))},toggleFullscreen:P,undoChanges:v,saveChanges:()=>n(),hasUnsavedChanges:!i,recordingToggleChange:f,isDelaySupported:s})})]})},TextArea=styled.textarea`
  box-sizing: border-box;
  background: var(--bg_control);
  padding: 5px 10px;
...
`,ColumnDiv=styled.div`
  display: flex;
  flex-direction: column;
`;class EncoderModeToggle extends React.Component{constructor(){super(...arguments);b(this,"handleInputChange",n=>{const{enabledModes:r,onChange:s}=this.props,{target:{checked:a,name:i}}=n,c=1<<MODES[i],l=a?r|c:r&~c;s(l)});b(this,"isChecked",n=>(1<<n&this.props.enabledModes)>0)}render(){return jsxs(CenteredColumnDiv,{children:[jsx("h3",{children:"Enabled Encoder Modes:"}),jsx("p",{children:"Only the selected encoder modes will be available on the keyboard"}),jsx(ColumnDiv,{children:Object.entries(MODES).map(([n,r])=>jsxs("label",{htmlFor:MODE_LABELS[n],children:[jsx("input",{name:n,id:MODE_LABELS[n],type:"checkbox",checked:this.isChecked(r),onChange:this.handleInputChange},r),MODE_LABELS[n]]},r))})]})}}const NormalInput=styled.input`
  border: none;
  border-bottom: 1px solid var(--bg_control);
  color: var(--color_accent);
  background: var(--bg_menu);
...
`).map(c=>jsx("li",{children:c},c))}),jsxs("ul",{children:[jsxs("li",{children:["Device: ",s]}),jsxs("li",{children:["Vid: ",printId(a)]}),jsxs("li",{children:["Pid: ",printId(r)]})]})]},n))})};async function saveErrors(e,o,n,r){try{const s=await window.showSaveFilePicker({suggestedName:`${n}.csv`}),a=[o.join(", ")],i=e.map(r),c=a.concat(...i).join(`
...
`,EncoderKey=e=>jsx(EncoderKeyContainer,{onClick:e.onClick,style:e.style,children:jsx(EncoderKeyContent2,{$size:e.size&&+e.size,$innerPadding:5*e.size/52})}),getMacroData=({macroExpression:e,label:o})=>o&&o.length>15?o:e&&e.length?e:null,paintKeycapLabel=(e,o,n)=>{const r=e.getContext("2d");if(r==null)return;const s=devicePixelRatio,[a,i]=[e.width,e.height];e.width=a*s,e.height=i*s,e.style.width=`${a}px`,e.style.height=`${i}px`,r.scale(s,s);const c='Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif',l={x:4,y:4},d={x:4,y:4},u={x:3,y:0},_={x:4,y:4};if(r.beginPath(),r.moveTo(0,0),r.lineTo(e.width,0),r.lineTo(e.width,e.height),r.lineTo(0,e.height),r.lineTo(0,0),r.clip(),r.fillStyle=o,n!==void 0){if(n.topLabel&&n.bottomLabel){let p=16,C=.75*p,K=n.offset[0]*C,h=n.offset[1]*C;r.font=`bold ${p}px ${c}`,r.fillText(n.topLabel,l.x,l.y+K+C),r.fillText(n.bottomLabel,d.x,i-d.y-h)}else if(n.centerLabel){let p=13*n.size,C=.75*p,K=i/2;return r.font=`bold ${p}px ${c}`,r.fillText(n.label,u.x,K+.5*C),r.measureText(n.centerLabel).width>a-u.x}else if(typeof n.label=="string"){let p=22,C=.75*p;r.font=`bold ${p}px ${c}`,r.fillText(n.label,_.x,_.y+C)}}},paintKeycap=(e,o,n,r,s)=>{const[a,i]=[CSSVarObject.keyWidth,CSSVarObject.keyHeight];if(e.width=a*o-CSSVarObject.faceXPadding.reduce((l,d)=>l+d,0),e.height=i*n-CSSVarObject.faceYPadding.reduce((l,d)=>l+d,0),e.getContext("2d")!=null)return paintKeycapLabel(e,r,s)},Keycap=React.memo(e=>{const{label:o,scale:n,color:r,selected:s,disabled:a,mode:i,rotation:c,keyState:l,shouldRotate:d,textureWidth:u,textureHeight:_,skipFontCheck:p,idx:C}=e,K=o&&getMacroData(o),[h,g]=reactExports.useState(!1),[y,m]=reactExports.useState(!1),S=reactExports.useRef(null),f=React.useCallback(()=>{if(S.current&&r&&o&&(document.fonts.check("bold 16px Inter",o.label)||p)){const A=paintKeycap(S.current,u,_,r.t,o);g(!!A)}},[S.current,u,o&&o.key,n[0],n[1],r&&r.t,r&&r.c,d]);reactExports.useEffect(f,[o&&o.key,p,r&&r.c,r&&r.t]),reactExports.useEffect(()=>(document.fonts.addEventListener("loadingdone",f),()=>{document.fonts.removeEventListener("loadingdone",f)}),[]);const[E,v]=[-8,0],M=DisplayMode.Test===i?TestKeyState.KeyDown===l?KeycapState.Pressed:KeycapState.Unpressed:y||s?KeycapState.Pressed:KeycapState.Unpressed,[T]=M===KeycapState.Pressed?[E,c[2]]:[v,c[2]+Math.PI*Number(d)],R=l===TestKeyState.KeyUp,D=DisplayMode.Test===i?M===KeycapState.Unpressed?R?"mediumvioletred":"lightgrey":"mediumvioletred":(M===KeycapState.Unpressed,"lightgrey"),O=M===KeycapState.Unpressed?R?.4:0:.6,[I,P,x,w]=reactExports.useMemo(()=>{const A=()=>{};return a?[A,A,A,A]:e.mode===DisplayMode.ConfigureColors?[A,L=>{e.onPointerOver&&e.onPointerOver(L,C)},A,L=>{e.onPointerDown&&e.onPointerDown(L,C)}]:[L=>e.onClick(L,C),L=>{e.onPointerOver&&e.onPointerOver(L,C),m(!0)},()=>m(!1),L=>{e.onPointerDown&&e.onPointerDown(L,C)}]},[a,e.onClick,e.onPointerDown,e.onPointerOver,m,C,i]);return d?jsx(EncoderKey,{onClick:I,size:u*CSSVarObject.keyWidth,style:{transform:`translate(${e.position[0]-(CSSVarObject.keyWidth*u-CSSVarObject.keyWidth)/2}px,${u*(CSSVarObject.keyHeight-CSSVarObject.keyWidth)/2+e.position[1]-(CSSVarObject.keyHeight*_-CSSVarObject.keyHeight)/2}px) rotate(${-e.rotation[2]}rad)`,borderRadius:3,color:e.color.c}}):e.clipPath?jsx(ComboKeycap,{...e,onClick:I,onPointerDown:w,onPointerOver:P,onPointerOut:x,keycapZ:T,keycapOpacity:O,keycapColor:D,canvasRef:S,macroData:K,overflowsTexture:h,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*u-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*_-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:u*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:_*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing}}):jsx(Fragment,{children:jsxs(KeycapContainer,{onClick:I,onPointerDown:w,onPointerOver:P,onPointerOut:x,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*u-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*_-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:u*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:_*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing,cursor:a?"initial":"pointer"},children:[jsxs(GlowContainer,{$selected:s,style:{animation:a?"initial":s?".75s infinite alternate select-glow":"",background:getDarkenedColor(e.color.c,.8),transform:`perspective(100px) translateZ(${T}px)`,borderRadius:3,width:u*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:_*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing},children:[DisplayMode.Test===i?jsx(TestOverlay,{style:{background:D,opacity:O}}):null,jsx(CanvasContainer,{style:{borderRadius:4,background:e.color.c,height:"100%"},children:jsx("canvas",{ref:S,style:{}})})]}),(K||h||o&&o.shortName)&&jsx(TooltipContainer,{$rotate:c[2],children:jsx(Keycap2DTooltip,{children:K||o&&o.tooltipLabel})})]})})},shallowEqual),GlowContainer=styled.div`
  box-sizing: border-box;
  padding: 2px 6px 10px 6px;
  transition: transform 0.2s ease-out;
  box-shadow: inset -1px -1px 0 rgb(0 0 0 / 20%),
...
`,KeyboardRouteGroup=styled.div`
  ...
  align-items: center;
  justify-content: center;
`,CanvasRouter=()=>{const[e]=useLocation(),o=reactExports.useRef(document.body),n=reactExports.useRef(null),r=useAppSelector(getLoadProgress),{progress:s}=useProgress(),a=useAppDispatch(),i=useSize(n),c=useSize(o),l=Object.values(useAppSelector(getCustomDefinitions)),d=useAppSelector(getSelectedDefinition),u=useAppSelector(getDesignDefinitionVersion),_=useAppSelector(getSelectedTheme),p=reactExports.useMemo(()=>_[dist.KeyColorType.Accent].c,[_]),C=e==="/"&&(!d||r!==1),K=reactExports.useMemo(()=>l.filter(v=>v[u]),[l,u]),h=e==="/design"&&!K.length,g=e==="/"&&(!d||(r+s/100)/2!==1),y=reactExports.useCallback(()=>{a(updateSelectedKey(null))},[a]),S=!("hid"in navigator||OVERRIDE_HID_CHECK)||["/settings","/errors"].includes(e)||h||g,f=useAppSelector(getConfigureKeyboardIsSelectable),E=C;return jsx(Fragment,{children:jsx("div",{style:{height:500,width:"100%",top:0,transform:S?E?c?`translateY(${-300+c.height/2}px)`:"":"translateY(-500px)":"",position:S&&!E?"absolute":"relative",overflow:"visible",zIndex:2,visibility:S&&!E?"hidden":"visible"},onClick:v=>{v.target.nodeName!=="CANVAS"&&a(clearSelectedKey())},ref:n,children:S?null:jsxs(Fragment,{children:[jsx(KeyboardBG,{onClick:y,$color:p,$visible:!E}),jsx(KeyboardGroup,{containerDimensions:i,configureKeyboardIsSelectable:f,loadProgress:r})]})})})},getRouteX=e=>{switch(e){case"/debug":return-300;case"/design":return-200;case"/test":return-100;case"/":return 0;default:return-300}},KeyboardGroupContainer=styled.div`
  z-index: 2;
  display: block;
  white-space: nowrap;
  height: 100%;
